...
As discussed in section~\ref{sub:twitter_as_a_data_source}, Twitter has a disturbingly low signal-to-noise ratio, so we had to examine every opportunity to refine the data retrieval step.
