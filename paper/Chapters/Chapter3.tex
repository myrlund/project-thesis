...
The sentiment analysis step assigns a sentiment class to each associated Twitter message from the previous step. The sentiments are either ``positive'', ``neutral'', or ``negative''.
