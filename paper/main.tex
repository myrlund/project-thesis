...
Many movie recommendation systems today use collaborative filtering techniques at their core. An important challenge for collaborative filtering techniques left today is their ability to handle data sparsity. This work attempts to solve the \emph{new item problem} by predicting movie ratings based on the perceived sentiment in Twitter search results.
